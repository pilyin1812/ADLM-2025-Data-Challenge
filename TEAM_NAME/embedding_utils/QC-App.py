...
base_dir = st.sidebar.text_input("Base Chroma folder", value="TEAM_NAME/chroma")
...
llm_model = st.text_input("Local LLM", value="llama3.1")

log_csv = st.text_input("Results CSV (optional):", value="TEAM_NAME/QC-Logs/QC_results.csv")
